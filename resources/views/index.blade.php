        ...
        <div class="content-header">
            <div class="">
                <div class="row mb-2">
                    @if(Auth::user()->role==1)
                    <div class="col">
                        <a href="{{ route('a_dashboard') }}" class="">
                            <button class="btn btn-outline-success btn-lg font-weight-bolder float-right mr-2 p-1">Admin Dashboard
                            </button>
                        </a>
                    </div>
                    @endif
                    @if(Auth::user()->role==3)
                    <div class="col">
                        <a href="{{ route('u_dashboard') }}" class="">
                            <button class="btn btn-outline-success btn-lg font-weight-bolder float-right mr-2 p-1">User
                                Profile
                            </button>
                        </a>
                    </div>
                                ...
                                <div class="direct-chat-messages">
                                    ...
                                    <div class="direct-chat-msg">
                                        ...
                                        <div class="direct-chat-text">
                                            Is this template really for free? That@php
                                            echo "'";
                                            @endphps unbelievable!
                                        </div>
                                        <!-- /.direct-chat-text -->
                                    </div>
                                    <!-- /.direct-chat-msg -->
